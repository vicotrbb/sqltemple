...
export const OpenFileIcon: React.FC<IconProps> = (props) => (
  <Icon {...props}>
...
export const ExportIcon: React.FC<IconProps> = (props) => (
  <Icon {...props}>
    ...
    <path d="M20.39 15.39A7.5 7.5 0 0 0 16 6h-1.26a8 8 0 1 0-9.05 4" />
  </Icon>
);
...
export const ConnectIcon: React.FC<IconProps> = (props) => (
  <Icon {...props}>
    <path d="M6 10a2 2 0 1 1-4 0a2 2 0 0 1 4 0zM22 10a2 2 0 1 1-4 0a2 2 0 0 1 4 0z" />
