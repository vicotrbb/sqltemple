...
export class AIService {
  ...
  async optimizeQuery(query: string): Promise<AIServiceResult<string>> {
    try {
      ...
      if (result.success && result.result) {
        ...
        return {
          success: false,
          error: result.error || "Failed to optimize query",
        };
      }
    } catch (error) {
      errorService.logAIError(
  ...
  async createQuery(prompt: string): Promise<AIServiceResult<string>> {
    try {
      ...
      if (result.success && result.result) {
        ...
        return {
          success: false,
          error: result.error || "Failed to create query",
        };
      }
    } catch (error) {
      errorService.logAIError(
  ...
  > {
    try {
      ...
      if (result.success && result.config) {
        ...
        return {
          success: false,
          error: result.error || "Failed to get AI config",
        };
      }
    } catch (error) {
      errorService.logAIError(
  ...
  async setConfig(config: {
    ...
    try {
      ...
      if (result.success) {
        ...
        return {
          success: false,
          error: result.error || "Failed to set AI config",
        };
      }
    } catch (error) {
      errorService.logAIError(
  ...
  async validateConfig(config: {
    ...
    model: string;
    baseUrl?: string;
  }): Promise<AIServiceResult<boolean>> {
    try {
      ...
      if (result.success) {
        ...
        return {
          success: false,
          error: result.errors?.join(", ") || "Failed to validate AI config",
        };
      }
    } catch (error) {
      errorService.logAIError(
  ...
  async getModels(
    ...
    try {
      ...
      if (result.success && result.models) {
        ...
        return {
          success: false,
          error: result.error || "Failed to get AI models",
        };
      }
    } catch (error) {
      errorService.logAIError(
  ...
  > {
    try {
      ...
      if (result.success && result.providers) {
        ...
        return {
          success: false,
          error: result.error || "Failed to get AI providers",
        };
      }
    } catch (error) {
      errorService.logAIError(
  ...
  async analyzePlan(
    ...
    try {
      ...
      if (result.success && result.result) {
        ...
        return {
          success: false,
          error: result.error || "Failed to analyze plan",
        };
      }
    } catch (error) {
      errorService.logAIError(
